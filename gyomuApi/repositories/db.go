...
func WithGorm(dialect, ConnectionInfo string) DBServicesConfig {
...
func WithLogMode(mode bool) DBServicesConfig {
	return func(s *DBServices) error {
		s.db.LogMode(mode)
		return nil
	}
...
func WithUser(pepper, hmacKey string) DBServicesConfig {
	return func(s *DBServices) error {
